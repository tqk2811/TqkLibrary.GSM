...
namespace TqkLibrary.GSM.Extended
{
    ...
    {
        internal CommandRequestCNMI(IGsmClient gsmClient) : base(gsmClient, "CNMI")
        {
    ...
    public static class CommandRequestCNMIExtension
    {
        ...
        /// <returns></returns>
        public static CommandRequestCNMI CNMI(this IGsmClient gsmClient) => new CommandRequestCNMI(gsmClient);
    }
}
