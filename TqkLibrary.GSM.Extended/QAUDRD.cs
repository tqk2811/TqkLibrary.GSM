...
namespace TqkLibrary.GSM.Extended
{
    ...
    {
        internal CommandRequestQAUDRD(IGsmClient gsmClient) : base(gsmClient, "QAUDRD")
        {
...
#pragma warning restore CS1591 // Missing XML comment for publicly visible type or member
    ...
    public static class CommandRequestQAUDRDExtension
    {
        ...
        /// <returns></returns>
        public static CommandRequestQAUDRD QAUDRD(this IGsmClient gsmClient) => new CommandRequestQAUDRD(gsmClient);
    }
}
