...
namespace TqkLibrary.GSM.Extended
{
    ...
    {
        internal CommandRequestQSPN(IGsmClient gsmClient) : base(gsmClient, "QSPN")
        {
    ...
    public static class CommandRequestQSPNExtension
    {
        ...
        /// <returns></returns>
        public static CommandRequestQSPN QSPN(this IGsmClient gsmClient) => new CommandRequestQSPN(gsmClient);
    }
}
