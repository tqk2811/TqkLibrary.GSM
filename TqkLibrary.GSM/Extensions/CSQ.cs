...
namespace TqkLibrary.GSM.Extensions
{
    ...
    {
        internal CommandRequestCSQ(GsmClient gsmClient) : base(gsmClient, "CSQ")
        {
...
#pragma warning restore CS1591 // Missing XML comment for publicly visible type or member
    ...
    public static class CommandRequestCSQExtension
    {
        ...
        /// <returns></returns>
        public static CommandRequestCSQ CSQ(this GsmClient gsmClient) => new CommandRequestCSQ(gsmClient);
    }
}
