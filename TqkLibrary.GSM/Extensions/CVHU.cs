...
namespace TqkLibrary.GSM.Extensions
{
    ...
    {
        internal CommandRequestCVHU(GsmClient gsmClient) : base(gsmClient, "CVHU")
        {
    ...
    public static class CommandRequestCVHUExtension
    {
        ...
        /// <returns></returns>
        public static CommandRequestCVHU CVHU(this GsmClient gsmClient) => new CommandRequestCVHU(gsmClient);
    }
}
