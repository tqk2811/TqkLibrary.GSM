...
namespace TqkLibrary.GSM.Extensions
{
    ...
    {
        internal CommandRequestCLIP(GsmClient gsmClient) : base(gsmClient, "CLIP")
        {
...
#pragma warning restore CS1591 // Missing XML comment for publicly visible type or member
    ...
    public static class CommandRequestCLIPExtension
    {
        ...
        /// <returns></returns>
        public static CommandRequestCLIP CLIP(this GsmClient gsmClient) => new CommandRequestCLIP(gsmClient);
    }
}
