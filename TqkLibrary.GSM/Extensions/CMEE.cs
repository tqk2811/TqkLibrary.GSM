...
namespace TqkLibrary.GSM.Extensions
{
    ...
    {
        internal CommandRequestCMEE(GsmClient gsmClient) : base(gsmClient, "CMEE")
        {
    ...
    public static class CommandRequestCMEEExtension
    {
        ...
        /// <returns></returns>
        public static CommandRequestCMEE CMEE(this GsmClient gsmClient) => new CommandRequestCMEE(gsmClient);
    }
}
