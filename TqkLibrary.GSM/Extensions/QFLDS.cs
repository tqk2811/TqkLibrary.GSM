...
namespace TqkLibrary.GSM.Extensions
{
    ...
    {
        internal CommandRequestQFLDS(GsmClient gsmClient) : base(gsmClient, "QFLDS")
        {
    ...
    public static class CommandRequestQFLDSExtension
    {
        ...
        /// <returns></returns>
        public static CommandRequestQFLDS QFLDS(this GsmClient gsmClient) => new CommandRequestQFLDS(gsmClient);
    }
}
